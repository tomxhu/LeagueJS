...
(function () {
    ...
    var League = {},
        ...
        matchUrl = '/v2.2/match',
        matchListUrl = '/v2.2/matchlist/by-summoner',
    ...
    League.getMatchList = function(summonerId, options, regionOrFunction, callback) {
        var url,
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            historyOptions = '';
        if(options) {
        ...
        url = util.craftUrl(endpoint, regionAndFunc.region, matchListUrl + '/' +
